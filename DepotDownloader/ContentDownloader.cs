...
namespace DepotDownloader
{
    ...
    static class ContentDownloader
    {
        ...
        // Current app config directory for storing manifests and depot keys
        private static string currentAppConfigDir;
        ...
        private static async Task<DepotFilesData> ProcessDepotManifestAndFiles(CancellationTokenSource cts, DepotDownloadInfo depot, GlobalDownloadCounter downloadCounter)
        {
            ...
            // Use the app config directory for manifest storage (game name folder)
            var configDir = currentAppConfigDir ?? Path.Combine(depot.InstallDir, CONFIG_DIR);
